...
def generateVideo(text, line2, vId):
    ...
    # Create the text
    txt_clip = (
        TextClip(fnlTxt, fontsize=ftSz, color='white',
                 font=fontPth, align="West")
        .set_position('left')
        .set_start(0.6)
        .set_duration(1.4)
    )
    line2C = (
        TextClip(line2, fontsize=ftSz, color='white',
                 font=fontPth, align="center")
        .set_position('left')
        .set_start(2)
        .set_duration(2.4)
    )
    ...
    result = CompositeVideoClip(
        [video, txt_mov, line2C, line2E])  # Overlay text on video
